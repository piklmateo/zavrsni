  ...
  async () => {
    try {
      ...
      const res = await fetch(
        "https://zavrsni-server.vercel.app/api/reservations",
        {
          method: "GET",
          headers: {
...
export const fetchReservationsStandard = createAsyncThunk(
  ...
  async () => {
    try {
      ...
      const res = await fetch(
        "https://zavrsni-server.vercel.app/api/reservations/standard",
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
...
export const fetchReservationsWholeDay = createAsyncThunk(
  ...
  async () => {
    try {
      ...
      const res = await fetch(
        "https://zavrsni-server.vercel.app/api/reservations/special",
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
...
export const fetchBookedDates = createAsyncThunk(
  ...
  async () => {
    try {
      const res = await fetch(
        "https://zavrsni-server.vercel.app/api/reservations/bookedDate",
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
...
export const fetchBookedTime = createAsyncThunk(
  ...
  async (date: string) => {
    try {
      const res = await fetch(
        `https://zavrsni-server.vercel.app/api/reservations/bookedTime/${date}`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
...
export const fetchBookedTables = createAsyncThunk(
  ...
  async ({ date, time }: { date: string; time: string }) => {
    try {
      const res = await fetch(
        `https://zavrsni-server.vercel.app/api/reservations/bookedTables/${date}/${time}`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
...
export const fetchUserReservations = createAsyncThunk(
  ...
  async () => {
    try {
      ...
      const res = await fetch(
        "https://zavrsni-server.vercel.app/api/users/reservations/" + id_user,
        {
          method: "GET",
          headers: {
            "Content-type": "application/json",
...
export const fetchSpecialUserReservations = createAsyncThunk(
  ...
  async () => {
    try {
      ...
      const res = await fetch(
        "https://zavrsni-server.vercel.app/api/users/reservations/special/" +
          id_user,
        {
          method: "GET",
          headers: {
