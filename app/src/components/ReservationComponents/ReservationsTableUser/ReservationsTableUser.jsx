...
} from "../../../state/slices/reservations/reservationsSlice.js";
...
const ReservationsTableUser = () => {
  ...
  const reservationsUserList = useSelector((state) => state.reservations.userReservations);
  const specialReservationsList = useSelector((state) => state.reservations.userSpecialReservations);
