...
const OrderItemCard = ({ item, handleRemoveItem, handleAddItem }: OrderItemCardProps) => {
  return (
    <div className="order__grid__item" key={(item as Drink).id_drink || (item as Dish).id_dish}>
